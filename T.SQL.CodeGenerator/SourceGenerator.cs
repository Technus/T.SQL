...
{
    private static DiagnosticDescriptor GeneretedFileDescriptor { get; } = new("T_SQL_CodeGenerator", "File Generated", "File Generated: {0}", "Files", DiagnosticSeverity.Info, true);

    internal const string TableAttribute = "T.SQL.Core.TableAttribute";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(compilationAndClasses, static (spc, src) => Execute(src.Left, src.Right, spc));
    }
